...
[PyQHA](https://github.com/MineralsCloud/PyQHA.jl).
...
version of PyQHA, type

```@repl
using Pkg
Pkg.update()
pkg"add https://github.com/MineralsCloud/PyQHA.jl"
```
...
our [GitHub repository](https://github.com/MineralsCloud/PyQHA.jl)
for new releases.
Once we release a new version, you can update PyQHA by typing
